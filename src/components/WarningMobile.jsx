...
export default function WarningMobile() {
  ...
  return (
    <>
      <div className="py-4 sm:h-12 lg:h-10 xl:h-8 px-3 bg-yellow-200 dark:bg-slate-700 w-full flex md:hidden lg:hidden items-center justify-center text-slate-600 dark:text-slate-200 text-sm ">
        <span className="pr-2">
          <svg
